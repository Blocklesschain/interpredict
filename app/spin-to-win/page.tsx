    ...
    <main className="min-h-screen overflow-hidden text-foreground selection:bg-primary/20">
      ...
      <div className="light-leaks relative isolate px-4 pb-20 pt-32 sm:px-6 md:pt-40">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid items-start gap-8 xl:grid-cols-[minmax(0,1fr)_minmax(360px,0.72fr)]">
            <section className="grid items-center gap-8 rounded-3xl border border-border bg-background/25 p-5 sm:p-8 lg:grid-cols-[minmax(0,0.85fr)_minmax(360px,1fr)]">
